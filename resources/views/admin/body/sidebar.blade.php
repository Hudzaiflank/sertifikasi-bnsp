        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/reports') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    {{-- <li><a href="{{ route('attendance.report.view') }}"><i class="ti-more"></i>Attendance Report</a></li> --}}
                    {{-- <li><a href="{{ route('student.result.view') }}"><i class="ti-more"></i>Student Result</a></li> --}}
                    {{-- <li><a href="{{ route('student.idcard.view') }}"><i class="ti-more"></i>Student ID Card</a></li> --}}
                </ul>
            </li>
