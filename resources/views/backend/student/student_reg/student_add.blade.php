                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <form id="studentForm" method="post" action="{{ route('store.student.registration') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <!-- 1st Row -->
...
<!-- Script untuk menghitung dan menampilkan umur -->
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Menghitung dan menampilkan umur secara dinamis
        $('#dob').on('change', function() {
            ...
            if (dob) {
                ...
                $('#ageDisplay').text('-'); // Jika tidak ada tanggal yang dipilih
            }
        });
        ...
        $('#studentForm').on('submit', function(e) {
            ...
            if (dob) {
                ...
                // Jika usia kurang dari 0 tahun, atur jadi 0
                if (age < 0) {
                    age = 0;
                }
                ...
                if (age < 10) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'Umur anda adalah ' + age + ' tahun, syarat minimal adalah 10 tahun.',
                    });
                }
            }
        });
